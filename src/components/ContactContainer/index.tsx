...
export const ContactContainer = () => {
  ...
  return (
    <div className="w-4/5 p-4 border-box mt-5 flex flex-col items-center gap-8">
      ...
      {filteredContacts.length > 0 ? (
        <button
          ...
          className="py-2 px-4 border-box bg-amber-600 rounded-xl text-sm text-stone-100 hover:bg-amber-800 transition duration-0 hover:duration-300 cursor-pointer"
        >
          Voltar
        </button>
      ) : null}
      ...
      <div className="flex flex-col items-center bg-[url('./assets/wallpaper1.jpg')] w-full bg-opacity-20  rounded-3xl">
        <div className="flex flex-col gap-8 items-center w-full bg-stone-100 bg-opacity-70 p-4 border-box">
